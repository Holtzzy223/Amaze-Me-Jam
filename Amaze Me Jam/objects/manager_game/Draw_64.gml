...

{
...

    {
		...
		{
		  draw_sprite_ext(spr_radar, 0, display_get_gui_width()/11 + lengthdir_x(d,a),display_get_gui_height()/6 + lengthdir_y(d,a),1,1,image_angle,c_red,wave(0.4,0.8,1,0.25));
		}

...
function camera_initialize()
{
	...
	function camera_update(){
		...
		#region GETSET { Camera-look values }
			...
			// Joystick looking
			Angle -= ( gamepad_axis_value( Device, gp_axisrv) ) *Sens.Joystick.x *Sensitivity *LookAxisV;
			Pitch += ( gamepad_axis_value( Device, gp_axisrh) ) *Sens.Joystick.y *Sensitivity *LookAxisH;
